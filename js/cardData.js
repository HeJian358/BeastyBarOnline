export const CARD_TYPES = {
    skunk:  { id: 'skunk',  power: 1,  text: "臭鼬" },   // 杀最大
    parrot: { id: 'parrot', power: 2,  text: "鹦鹉" },   // 嘴臭踢人
    kanga:  { id: 'kanga',  power: 3,  text: "袋鼠" },   // 插队
    ...
    croc:   { id: 'croc',   power: 10, text: "河马" },   // 你修正的
    hippo:  { id: 'hippo',  power: 11, text: "鳄鱼" },   // 你修正的
